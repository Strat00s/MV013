...
|---------------------------|--------------------------------------------|
| `Exponential` | The dataset seems to be closer to exponential distribution rather than the lognormal. Using Akaike test give smaller value for exponential distribution, which suggests that the data are closer to exponential distribution rather than lognormal distribution. |
...
|--------------------------------|------------------------------------------------------------------|
| `Two-sample Wilcox Test`  | `We are testing two independant groups which seem to have non-normal distribution. Specifically I want to use one-tailed version.` |
...
#And looking at difference in location and CI, it seems
