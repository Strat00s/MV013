...
|---------------------------------------------------------------------------------------------------|--------------------|
| `cholesterol_log ~ age + vegetarian + blood_pressure_systolic_log + blood_pressure_diastolic_log` | `0.973`            |
...
|-----------------------------|------------------------------------------------------------------------------------------------------|
| `0.973`                     | `It means that about 97.3% of the variation in cholesterol variable can be explained by this model.` |
