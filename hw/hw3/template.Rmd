...
+=====================+================================================================================================================================+
| `0.509`             | `I fail to reject the null hypothesis. There does not seem to be statistically significant correlation between IQ and weight.` |
+---------------------+--------------------------------------------------------------------------------------------------------------------------------+
...
+=====================+=======================================================================================+===============+===================================================================================================================+
| `one-sample t-test` | `We want to know if the samples come from a population with a specific mean (125kg).` | `0.18`        | I fail to reject null hypothesis. There is not enough evidence to say that the average weight is less than 125kg. |
|                     |                                                                                       |               |                                                                                                                   |
|                     | `H0 - average weight equals 125 kg`                                                   |               |                                                                                                                   |
|                     |                                                                                       |               |                                                                                                                   |
|                     | `HA - average weight is less than 125 kg`                                             |               |                                                                                                                   |
+---------------------+---------------------------------------------------------------------------------------+---------------+-------------------------------------------------------------------------------------------------------------------+
...
| Name of the test    | Explanation                                                                                   | p-value       | conclusion                                                                                                                                               |
+=====================+===============================================================================================+===============+==========================================================================================================================================================+
| `tow-sample t-test` | `We have 2 independand dataset and want to test if their average product weight is the same.` | `0.669`       | I fail to reject null hypothesis. There is not enough evidence to suggest that the average weight of production between both farms differ significantly. |
|                     |                                                                                               |               |                                                                                                                                                          |
|                     | `H0 - Average weight is same`                                                                 |               |                                                                                                                                                          |
|                     |                                                                                               |               |                                                                                                                                                          |
|                     | `HA - Average weight differ signifficantly`                                                   |               |                                                                                                                                                          |
+---------------------+-----------------------------------------------------------------------------------------------+---------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|---------------------------------------|--------------------|
| `log(cholesterol) ~ age * vegetarian` | `0.969`            |
...
+=========================================+======================+=================================================================================================================================================================================================+
| `age`                                   | `0.027`              | `Change in log(cholesterol) for each one-year increase in age. Can be interpreted also as 2.7% increase in log(cholesterol) for each aditional year of age.`                                    |
+-----------------------------------------+----------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-----------------------------------------+----------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| `age:vegetarian`                        | `-0.005`             | `Interaction term. It represents the difference in rate of change in log(cholesterol) for a one-year increase in age between meat-eaters and vegetarians.`                                      |
|                                         |                      |                                                                                                                                                                                                 |
| `meat-eater`                            |                      |                                                                                                                                                                                                 |
+-----------------------------------------+----------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
